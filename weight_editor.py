...
keypairs = {
    "terms.term_emb": "terms.parent_emb",
    "root.root_emb": "root.parent_emb",
...
def change_keys(t: dict, keypairs: dict = keypairs):
    ...
    #         n_t["terms.parent_emb"] = v
    #     elif k == "root.root_emb":
    #         n_t["root.parent_emb"] = v
    #     elif "term_mlp" in k:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-o",
        type=Path,
        default="log/mftn_korean_std_left_right_bin_soft/MFTNPCFG2024-02-28-13_34_27/best.pt",
    )
    parser.add_argument(
        "--new",
        "-n",
        type=Path,
        default="log/mftn_korean_std_left_right_bin_soft/MFTNPCFG2024-02-28-13_34_27/best_new.pt",
    )
    parser.add_argument("--keypairs", "-k", type=Path, default="keypairs.yaml")
    args = parser.parse_args()
    main(args.old, args.new, args.keypairs)
